...
import numpy as np
from components import get_ppo_ac_cfg_defaults, get_ac_cfg_defaults, tensor
import agent
import torch
...
if __name__ == '__main__':
    ...
    agents = getattr(agent, AGENT_NAME)(env_path)
    agents.policy.load_state_dict(torch.load('./model-PPOACAgent-finish.pth'))
    while True:
        pred = agents.policy(tensor(states))
        actions = pred['a']
